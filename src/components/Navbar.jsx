...
const Navbar = () => {
    return (
        <nav className="bg-gray-700 shadow-2xl fixed left-0 right-0 flex md:flex-row md:justify-around justify-around  place-content-center items-center min-h-24">
